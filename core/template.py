...
class TemplateEngine:
    def __init__(self, templates_dir: Path | None = None, site_title: str | None = None, github_link: str | None = None):
        self.templates_dir: Path = templates_dir or config.TEMPLATES_DIR
        self.site_title: str = site_title or config.SITE_TITLE
        self.github_link: str = github_link or config.GITHUB_LINK
